...
class GameViewController: UIViewController, GKGameCenterControllerDelegate, UIAlertViewDelegate {
...
//    @objc func loadFBPage() {
//        let url = "https://www.facebook.com/AppBoo-257026071346825/"
//        UIApplication.shared.openURL(NSURL(string: url)! as URL)
//    }
    
    @objc func popRateUs(){
        let alert = UIAlertController(title: "Enjoying HYPER BRICK ?", message: "Write a review to let us know your thoughts", preferredStyle: UIAlertController.Style.alert)
